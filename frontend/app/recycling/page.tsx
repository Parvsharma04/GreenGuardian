...
import { BarChart3, Gift, QrCode, Recycle } from "lucide-react";
              ...
              {[
                {
                  ...
                  description:
                    "Use your points for a discount on sustainable products",
                  points: 500,
                  image:
                ...
                },
                {
                  ...
                  description:
                    "Redeem a free coffee at participating locations",
                  points: 350,
                  image:
                ...
                },
                {
                  title: "Plant a Tree",
                  description:
                    "We'll plant a tree in your name in a reforestation project",
                  points: 1000,
                  image:
          ...
          <TabsContent value="history" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your recycling contributions over time
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Expand the types of materials you recycle to earn bonus
                  points.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Invite friends to join GreenGuardian and earn 500 points per
                  referral.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Participate in monthly recycling challenges to earn bonus
                  rewards.
                </p>
              </div>
            </div>
